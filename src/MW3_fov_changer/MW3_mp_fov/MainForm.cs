...
namespace MW3_fov_changer
{
    ...
    public partial class MainForm : Form
    {
        ...
        public const string c_toolVer = "1.9.446.0";

        public const string c_checkURL = "http://agentrevmw3fov.crabdance.com/";
        //public const string c_checkURL = "http://agentrevmw3fov.crabdance.com/sp/";
        //public const string c_checkURL = "http://pastebin.com/raw.php?i=kJVxuWv9";
        ...
        int pFoV; // = DefaultGameMode.c_pFoV;
        float fFoV; // = DefaultGameMode.c_FoV;
        bool doBeep; // = DefaultGameMode.c_doBeep;
        bool updateChk; // = DefaultGameMode.c_updateChk;
